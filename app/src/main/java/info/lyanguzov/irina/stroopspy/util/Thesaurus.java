...
public class Thesaurus {
    ...
    private static final Word[] mainWords = new Word[]{
            ...
            new Word(Color.RED, Language.SPANISH, "Rojo"),
            new Word(Color.YELLOW, Language.SPANISH, "Amarillo"),
            new Word(Color.BLUE, Language.SPANISH, "Azul"),
            new Word(Color.GREEN, Language.SPANISH, "Verde"),
